<template>
    <div class="overflow-hidden overflow-x-auto min-w-full align-middle sm:rounded-md">
        <div class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
...
<script>
    ...
    import useCompaniesComposable from "../../composables/CompaniesComposable";

export default {
    setup() {
        const {companies, getCompanies, destroyCompany } = useCompaniesComposable();
